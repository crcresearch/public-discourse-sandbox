...
urlpatterns = [
    ...
    path(
        "<str:experiment_identifier>/<uuid:pk>/",
        view=user_profile_detail_view,
        name="detail_with_experiment",
    ),
    path(
        "<str:experiment_identifier>/update-profile/",
    ...
    path(
        "signup-with-profile/", CustomSignupView.as_view(), name="signup_with_profile"
    ),
