...
from public_discourse_sandbox.pds_app.external_api import api_get_post_comments_by_id
...
urlpatterns = [
    ...
    path(
        "api/v1/posts/<uuid:post_id>/comments",
        api_get_post_comments_by_id,
        name="api_get_post_comments_by_id",
    ),
