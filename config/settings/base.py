...
# public_discourse_sandbox/
APPS_DIR = BASE_DIR / "public_discourse_sandbox"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "public_discourse_sandbox.contrib.sites.migrations"}
...
ADMINS = [("""Kristina Radivojevic""", "kradivo2@nd.edu"),("""Caleb Reinking""", "creinkin@nd.edu"),("""Shaun Whitfield""", "swhitfie@nd.edu")]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Public Discourse Sandbox API",
    "DESCRIPTION": "Documentation of API endpoints of Public Discourse Sandbox",
    "VERSION": "1.0.0",
